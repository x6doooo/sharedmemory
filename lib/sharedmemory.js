...
Manager.prototype.plusOne = function(data) {
    var sm = this.__sharedMemory__;
    var key = data.key;
    var value = sm.get(key);
...
User.prototype.plusOne = function(key, cb) {
    this.handle('plusOne', key, cb);
};
/**
* 读取数据
* @method get
